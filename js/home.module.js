...
export class Home {
  constructor() {
    ...
    $("#Categories , #Area , #Ingredients , #contact , #search").on(
      "click",
      () => {
    ...
    for (let i = 1; i <= 20; i++) {
      if (mealName[`strIngredient${i}`]) {
        recipes += `<li class="alert alert-info m-2 p-1">${
          mealName[`strMeasure${i}`]
        } ${mealName[`strIngredient${i}`]}</li>`;
      }
    }
            ...
            <br/>
                ...
                <ul class="list-unstyled d-flex g-3 flex-wrap ">
                  ...
                  <li class="alert alert-danger m-2 p-1">${
                    mealName.strTags
                      ? mealName.strTags.split(",")[0]
                      : "unknown"
                  }</li>
    
                  ${
                    mealName.strTags.split(",")[1]
                      ? `<li class="alert alert-danger m-2 p-1"> ${
                          mealName.strTags
                            ? mealName.strTags.split(",")[1]
                            : "unknown"
